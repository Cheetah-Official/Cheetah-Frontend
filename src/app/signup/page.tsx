    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0A2384] p-4">
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-xs flex flex-col items-center">
        <div className="mb-4 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold mb-1 text-[#1A1A1A]">Sign Up Account</h2>
        ...
        <form className="w-full" onSubmit={handleSubmit((data) => mutation.mutate(data))}>
          ...
          <div className="mb-3">
            <div className="flex items-center mb-1">
              ...
              <label className="font-bold text-black text-sm" htmlFor="password">Create Password</label>
            </div>
            <input
              id="password"
              type="password"
          ...
          <div className="mb-3">
            <div className="flex items-center mb-1">
              <FaLock className="text-gray-400 w-4 h-4 mr-2" />
              <label className="font-bold text-black text-sm" htmlFor="confirmPassword">Confirm Password</label>
            </div>
            <input
              id="confirmPassword"
              type="password"
          ...
          {mutation.isError && (
            <div className="text-red-600 text-xs mb-2" role="alert">{(mutation.error as any)?.message || "Failed to create account"}</div>
          )}
          <button
            type="submit"
